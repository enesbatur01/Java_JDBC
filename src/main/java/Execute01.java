...
public class Execute01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //3. ADIM : Statement nesnesini oluşturma : SQL sorgularını DB ye gönderme ve çalıştırma
        ...
        //DQL için kullanılırsa : ResultSet nesnesi alınırsa TRUE değerini döndürür.
        ...
        //5.ADIM : Bağlantıyı ve statementı kapatma
        st.close();
        con.close();
